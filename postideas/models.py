...
class Card(models.Model):
    ...
    assignee = models.ForeignKey(User, related_name = 'assignee', blank = True, on_delete = models.CASCADE)
    created_at = models.DateTimeField(auto_now_add =True)
    team = models.ForeignKey(Team, related_name = 'workspace', null = True, on_delete = models.CASCADE)
    tag = models.CharField(blank = True, max_length=20,choices = tag_CHOICES)
