...
SECRET_KEY = "koshtamshepesh" #os.getenv("SECRET_KEY",)
...
EMAIL_HOST_USER ="swan.team2021@gmail.com"# os.getenv("EMAIL_HOST_USER", '')
EMAIL_HOST_PASSWORD ="uveggbfxaswolqzf" #os.getenv("EMAIL_HOST_PASSWORD", '')
