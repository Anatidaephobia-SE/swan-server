    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Drafts', 'Drafts'), ('Published', 'Published'), ('Schedule', 'Schedule')], default='Draft', max_length=20, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('tag', models.CharField(blank=True, choices=[('Ads', 'Ads'), ('Branding', 'Branding'), ('Celebration', 'Celebration'), ('News', 'News'), ('Quote', 'Quote'), ('Sales', 'Sales')], max_length=20, null=True)),
                ('published_id', models.BigIntegerField(blank=True, null=True)),
                ('schedule_time', models.DateTimeField(blank=True, null=True)),
                ('multimedia', models.ManyToManyField(blank=True, related_name='Post', to='filestorage.MediaStorage')),
