...
class CreatePostView(generics.CreateAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if post.status == 'Schedule':
            sc = Scheduler()
            if 'schedule_post' in data:
                sc.schedule_post(post, socialmedia, TaskType.Twitter, data['schedule_post'])
            print("**************************************",sc.get_post_scheduled_date(post, TaskType.Twitter))
            post.schedule_time=data['schedule_post']
