...
class Team(models.Model):
    ...
    pending_users = models.ManyToManyField(User, related_name = 'pending_users')
    head = models.ForeignKey('users.User', related_name = 'head', on_delete = models.CASCADE, null = False)
